...
namespace WebApi8_Video.Controllers
{
    ...
    public class LivroController : ControllerBase
    {
        ...
        [HttpPost("CriarLivro")]
        public async Task<ActionResult<ResponseModel<List<LivroModel>>>> CriarLivro(LivroCriacaoDTO autorCriacaoDTO)
        {
            var livros = await _livroInterface.CriarLivro(autorCriacaoDTO);
            return Ok(livros);
        }
